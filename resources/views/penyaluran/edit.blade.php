...
@section('konten')
    ...
    <div class="mx-auto max-w-3xl">
        <x-ui.kepala-halaman
            ...
            deskripsi="Koreksi data historis memang diperbolehkan — laporan lapangan kerap baru lengkap beberapa hari kemudian. Setiap perubahan tercatat pada riwayat data ini."
