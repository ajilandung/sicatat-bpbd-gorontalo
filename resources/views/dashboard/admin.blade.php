...
@section('konten')
    ...
    {{-- Panel khusus admin: kesiapan data master (bobot besar) berdampingan
         dengan ringkasan akun (bobot kecil), satu baris agar tidak menumpuk. --}}
    <div class="mt-8 grid gap-x-6 gap-y-6 lg:grid-cols-3">
        <div class="lg:col-span-2">
            <h2 class="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500">Kesiapan Data Master</h2>
        ...
        <div>
            <h2 class="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500">Pengguna Sistem</h2>
