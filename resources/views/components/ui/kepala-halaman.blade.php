...
<div {{ $attributes->merge(['class' => 'mb-6']) }}>
    @if ($kembali)
        <a href="{{ $kembali }}"
           class="mb-3 inline-flex items-center gap-1.5 rounded text-sm font-medium text-slate-500 transition-colors
                  hover:text-air-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-air-500">
    ...
    <div class="flex flex-wrap items-start justify-between gap-x-6 gap-y-4">
        <div class="min-w-0">
            {{-- Garis biru pendek: penanda identitas yang berulang di tiap halaman. --}}
